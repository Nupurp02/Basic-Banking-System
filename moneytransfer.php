                ...
                <div class="row">
                    <div class="col">
                        ...
                        <table class="table table-hover table-sm table-condensed table-bordered table-striped table-light">
                            <thead class="thead-dark">
                                ...
                                <th scope="col" class="text-center py-2">Select To Transfer</th>
                                </tr>
                            </thead>
                            <tbody>
                    <?php 
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="TransferToUser.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn btn-outline-primary ">Transfer Money</button></a></td> 
                        </tr>
                    <?php
                        }
                    ?>
